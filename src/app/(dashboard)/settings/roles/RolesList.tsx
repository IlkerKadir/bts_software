    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-primary-500">Kullanici rollerini ve izinlerini yonetin</p>
        </div>
      ...
      {/* Roles Grid */}
      {isLoading ? (
        <div className="text-center py-12 text-primary-500">Yukleniyor...</div>
      ) : roles.length === 0 ? (
        <Card>
            ...
            <Card key={role.id}>
              <div className="p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  <PermissionBadge enabled={role.canViewCosts} label="Maliyet Gorme" />
      ...
      >
        {deleteError ? (
          ...
          <p className="text-primary-700">
            <strong>{deletingRole?.name}</strong> rolunu silmek istediginize emin misiniz?
